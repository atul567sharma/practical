...
namespace Seepossible\Blog\Controller\Adminhtml\Blog;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Seepossible\Blog\Model\Blog::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('seepossible_blog_blog');
            ...
            $this->dataPersistor->set('seepossible_blog_blog', $data);
